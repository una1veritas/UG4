...
int MODE = 0;
int pathIndex = 0;
String[] path = new String[]{"C:/Users/tukushimbo/Documents/Processing/binaryFlow3/data", 
								"C:/Users/tukushimbo/workspace/sampleAA/bin"};
...
void setup(){
	...
	//GET VMCode data
	String[] vmList = loadStrings("C:/Users/tukushimbo/Documents/Processing/loadVMCode/data/VMCode.csv");
	...
	try{
		...
		for(int i=0; i<fList.length; i++){
			if(fList[i].matches(".*\\.class")){
				...
				ClassRead cl = new ClassRead(path[d], fList[i], ID++);
				if(!cl.check()){
					classes.add(cl);
				}
			}
